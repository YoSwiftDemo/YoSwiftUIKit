...
extension UIColor {
    ...
    public static var titleColor: UIColor {
        return UIColor(hexStr: "#666666")
    }
    //正常文本
    public static var textColor: UIColor {
        return UIColor(hexStr: "#999999")
    }
    //浅色 文本
    public static var lightTextColor: UIColor {
        return UIColor(hexStr: "#CCCCCC")
    }
    public static var lightBackgroundColor: UIColor {
        return UIColor(hexStr: "#000000").withAlphaComponent(0.04)
    }
    //白色透明8 字体浅色
    public static var white8Color: UIColor {
        return UIColor(hexStr: "#FFFFFF").withAlphaComponent(0.8)
    }
}
extension UIColor {
